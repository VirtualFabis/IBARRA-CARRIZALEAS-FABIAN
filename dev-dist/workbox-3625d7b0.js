define(["exports"], function (t) {
  ...
  const u = {
    ...
    f = {
      ...
      getGoogleAnalyticsName: (t) => t || l(u.googleAnalytics),
      getPrecacheName: (t) => t || l(u.precache),
      getPrefix: () => u.prefix,
      getRuntimeName: (t) => t || l(u.runtime),
      getSuffix: () => u.suffix,
    };
  function w(t, e) {
    const s = e();
  ...
  function p(t) {
    ...
    return i.searchParams.set(d, e), { cacheKey: i.href, url: r.href };
  }
  class y {
    constructor() {
      (this.updatedURLs = []),
  ...
  class x {
    constructor(t = {}) {
      (this.cacheName = f.getRuntimeName(t.cacheName)),
  ...
  class C extends x {
    constructor(t = {}) {
      (t.cacheName = f.getPrecacheName(t.cacheName)),
        super(t),
        ...
        });
      {
        ...
        (n = await e.fetch(
          ...
          s &&
            o &&
            "no-cors" !== t.mode &&
            (this.O(), await e.cachePut(t, n.clone()));
      }
      return n;
    }
    async C(t, e) {
  ...
  class E {
    ...
    addToCacheList(t) {
      ...
      for (const n of t) {
        ...
        if (this.P.has(i) && this.P.get(i) !== t)
        ...
        if ((this.P.set(i, t), this.j.set(i, r), e.length > 0)) {
  ...
  (t.NavigationRoute = class extends i {
    constructor(t, { allowlist: e = [/./], denylist: s = [] } = {}) {
      super((t) => this.S(t), t), (this.T = e), (this.W = s);
    }
    S({ url: t, request: e }) {
      if (e && "navigate" !== e.mode) return !1;
      const s = t.pathname + t.search;
      for (const t of this.W) if (t.test(s)) return !1;
      return !!this.T.some((t) => t.test(s));
    }
  }),
    (t.cleanupOutdatedCaches = function () {
      self.addEventListener("activate", (t) => {
        const e = f.getPrecacheName();
        t.waitUntil(j(e).then((t) => {}));
      });
    }),
    ...
    (t.createHandlerBoundToURL = function (t) {
      return O().createHandlerBoundToURL(t);
    }),
